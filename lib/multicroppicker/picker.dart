...
import 'package:brainfood/multicroppicker/album.dart';
import 'package:brainfood/multicroppicker/crop/crop.dart';
import 'package:brainfood/multicroppicker/media.dart';
import 'package:brainfood/multicroppicker/select_album_page.dart';
...
class __SelectMediaPageState extends State<_SelectMediaPage> {
  ...
  Future<InitData> fetchData() async {
    ...
    for (int i = 0; i < albums.length; i++) {
      albumMap.addAll({
        albums[i]: await albums[i].getAssetListPaged(page: 0, size: 100000)
      });
    }
