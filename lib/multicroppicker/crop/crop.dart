...
import 'dart:math';
import 'package:brainfood/multicroppicker/crop/crop_render.dart';
import 'package:brainfood/multicroppicker/crop/matrix_decomposition.dart';
import 'package:brainfood/multicroppicker/crop/rotation_gesture_detector.dart';
...
class _CropState extends State<Crop> with TickerProviderStateMixin {
  ...
  void _reCenterImage([bool animate = true]) {
    ...
    final ratio =
        sz.aspectRatio; //childWidgetSize.aspectRatio / sz.aspectRatio;
